...
public class MonthlyScheduleWithDOMTest {
  ...
  public void generateSchedule() {
	  ...
	  while (itr.hasNext()) {
		...
		MonthlyScheduleWithDOM monthlyScheduleWithDOM =  new MonthlyScheduleWithDOM(inputParams);
		monthlyScheduleWithDOM.generateSchedule(numberOfInstallments);
		scheduleList=monthlyScheduleWithDOM.scheduleList;
  ...
  public void getLengthOfPeriod() {
	  ...
	  while (itr.hasNext()) {
		...
		inputParams=new MigrationParams(account, customer, currency,createdDate,discursementDate, recurrenceId ,interestType, recurAfter, days, rankOfDays, dayNumber, loanAmount, amountPaid, interestRate,numberOfInstallments);
		MonthlyScheduleWithDOM monthlyScheduleWithDOM =  new MonthlyScheduleWithDOM(inputParams);
		lengthOfPeriodActual=monthlyScheduleWithDOM.getLengthOfPeriod();
  ...
  public void getLoanDuration() {
	  ...
	  while (itr.hasNext()) {
		...
		inputParams=new MigrationParams(account, customer, currency,createdDate,discursementDate, recurrenceId ,interestType, recurAfter, days, rankOfDays, dayNumber, loanAmount, amountPaid, interestRate,numberOfInstallments);
		MonthlyScheduleWithDOM monthlyScheduleWithDOM =  new MonthlyScheduleWithDOM(inputParams);
		loanDurationActual=monthlyScheduleWithDOM.getLoanDuration(numberOfInstallments);
