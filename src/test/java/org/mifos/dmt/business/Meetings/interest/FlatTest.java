...
// start of test method
  ...
  { 
	  ...
	  while (itr.hasNext()) {
		...
		//calling of the Flat interest method
	    ...
	    Flat flat = new Flat(inputParams);
	    flat.calculateLoanPayments();
	    principalPerInstallment=flat.getPrincipalPerInstallment();
	    interestPerInstallment=flat.getInterestPerInstallment();
