...
public class MonthlyScheduleWithRODTest {
  ...
  public void generateSchedule() {
	  ...
	  while (itr.hasNext()) {
		...
		MonthlyScheduleWithROD monthlyScheduleWithROD =  new MonthlyScheduleWithROD(inputParams);
		monthlyScheduleWithROD.generateSchedule(numberOfInstallments);
		scheduleList=monthlyScheduleWithROD.scheduleList;
  ...
  public void getLengthOfPeriod() {
	  ...
	  while (itr.hasNext()) {
		...
		inputParams=new MigrationParams(account, customer, currency,createdDate,discursementDate, recurrenceId ,interestType, recurAfter, days, rankOfDays, dayNumber, loanAmount, amountPaid, interestRate,numberOfInstallments);
		MonthlyScheduleWithROD monthlyScheduleWithROD =  new MonthlyScheduleWithROD(inputParams);
		lengthOfPeriodActual=monthlyScheduleWithROD.getLengthOfPeriod();
  ...
  public void getLoanDuration() {
	  ...
	  while (itr.hasNext()) {
		...
		inputParams=new MigrationParams(account, customer, currency,createdDate,discursementDate, recurrenceId ,interestType, recurAfter, days, rankOfDays, dayNumber, loanAmount, amountPaid, interestRate,numberOfInstallments);
		MonthlyScheduleWithROD monthlyScheduleWithROD =  new MonthlyScheduleWithROD(inputParams);
		loanDurationActual=monthlyScheduleWithROD.getLoanDuration(numberOfInstallments);
